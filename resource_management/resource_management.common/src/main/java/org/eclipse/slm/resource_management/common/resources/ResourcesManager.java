...
import org.eclipse.slm.resource_management.common.remote_access.RemoteAccessService;
...
public class ResourcesManager {
    ...
    private BasicResource addDetailsToResource(BasicResource resource) {
        ...
        var remoteAccessServicesIds = this.remoteAccessService.getRemoteAccessServiceIdsOfResource(resource.getId());
    ...
    public void deleteResource(
        ...
        try {
            ...
            for (var remoteAccessServiceId : resource.getRemoteAccessIds()) {
                this.remoteAccessService.deleteRemoteAccess(resourceId, remoteAccessServiceId);
            }
    ...
    public void setRemoteAccessOfResource(
        ...
        var ownerUserId = jwtAuthenticationToken.getToken().getSubject();
        this.remoteAccessService.addUsernamePasswordRemoteAccessService(ownerUserId, resourceId, connectionType, connectionPort, resourceUsername, resourcePassword);
    }
